<template>
  <div v-if="event" class="relative w-full h-full pb-16">
    ...
    >
      <h2
        class="px-2 text-2xl font-medium border-b-2 sm:text-2-5xl text-black-variant-900 pb-3 pt-6"
      >
        About Event
      </h2>
      <p class="px-2 text-base sm:text-lg text-black-800 mt-8">
      ...
      <h3
        class="px-2 text-2xl font-medium sm:text-2xl text-black-variant-900 mt-20"
      >
        Provisions
      </h3>
      <BaseList
      ...
      >
        <li
          ...
          :key="provision"
          class="text-lg flex items-center space-x-5"
        >
      ...
      <p v-else class="text-black-variant-300 text-lg px-6">
